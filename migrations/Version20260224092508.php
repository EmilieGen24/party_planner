 ...
 */
final class Version20260224092508 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD reset_token DATETIME DEFAULT NULL, ADD reset_token_expires_at DATETIME DEFAULT NULL');
    }
