 ...
 */
final class Version20260604124840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE theme_color (theme_id INT NOT NULL, color_id INT NOT NULL, INDEX IDX_3E74C30C59027487 (theme_id), INDEX IDX_3E74C30C7ADA1FB5 (color_id), PRIMARY KEY (theme_id, color_id)) DEFAULT CHARACTER SET utf8mb4');
