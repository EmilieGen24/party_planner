 ...
 */
final class Version20260604121937 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE color ADD hex_code VARCHAR(7) NOT NULL, DROP hexacode');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE color ADD hexacode VARCHAR(255) NOT NULL, DROP hex_code');
